...
Based on the results generated by these metrics, it appears that Case III (test and training data split ratio of 0.1:0.9) performs slightly better than the other cases for Logistic Regression.
...
Based on the results generated by these metrics, it appears that Case III (test and training data split ratio of 0.1:0.9) performs slightly better than the other cases for Logistic Classification.
